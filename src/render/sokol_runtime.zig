...
fn rebuildFtRenderer(app: *App) void {
    ...
    g_ft_renderer = FtRenderer.init(app.allocator, .{
        ...
        .regular_embolden = app.config.fonts.regular_embolden,
        .bold_embolden = app.config.fonts.bold_embolden,
        .italic_embolden = app.config.fonts.italic_embolden,
        .bold_italic_embolden = app.config.fonts.bold_italic_embolden,
